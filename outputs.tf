output "api_management_api_policies_id" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.id if v.id != null && length(v.id) > 0 }
}
output "api_management_api_policies_api_management_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.api_management_name if v.api_management_name != null && length(v.api_management_name) > 0 }
}
output "api_management_api_policies_api_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.api_name if v.api_name != null && length(v.api_name) > 0 }
}
output "api_management_api_policies_resource_group_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "api_management_api_policies_xml_content" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.xml_content if v.xml_content != null && length(v.xml_content) > 0 }
}
output "api_management_api_policies_xml_link" {
  ...
  value       = { for k, v in azurerm_api_management_api_policy.api_management_api_policies : k => v.xml_link if v.xml_link != null && length(v.xml_link) > 0 }
}
